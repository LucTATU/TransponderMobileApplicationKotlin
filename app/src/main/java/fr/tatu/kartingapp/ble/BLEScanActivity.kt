...
class BLEScanActivity : AppCompatActivity() {
    ...
    private fun initBLEScan() {
        ...
        bleDevicesList.addItemDecoration(DividerItemDecoration(this, LinearLayoutManager.VERTICAL))
    ...
    private fun togglePlayPauseAction() {
        if (mScanning) {
            ...
            playPauseAction.setImageDrawable(ContextCompat.getDrawable(this, android.R.drawable.ic_media_pause))
        } else {
            progressBar.visibility = View.INVISIBLE
            divider.visibility = View.VISIBLE
            scanTitle.text = getString(R.string.ble_scan_title_play)
            playPauseAction.setImageDrawable(ContextCompat.getDrawable(this, android.R.drawable.ic_media_play))
        }
    }
    ...
    object : ScanCallback() {
        ...
        override fun onScanFailed(errorCode: Int) {
            ...
            Toast.makeText(this@BLEScanActivity,getString(R.string.ble_scan_error),Toast.LENGTH_LONG).show()
        }
    }
